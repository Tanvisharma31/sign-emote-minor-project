...
export class MermaidChartComponent implements AfterViewInit {
 ...
 flowchart TD
    ...
    A1[Spoken Language Text] --> B[<a href='https://github.com/Tanvisharma31/sign-emote-minor-project/10'>Language Identification</a>]
    A1 --> C(<a href='https://github.com/Tanvisharma31/sign-emote-minor-projecttree/master/functions/src/text-normalization'>Normalized Text</a>)
    B --> C
    ...
    N --> H(<a href='https://github.com/Tanvisharma31/sign-emote-minor-project/68'>3D Avatar</a>)
